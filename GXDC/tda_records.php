...
//$startTime = date("2017-12-26 00:00:00");
//$stopTime = date("2017-12-26 23:59:59");
...
$txtFileName = "/toodo/crontab/txt/tdaRecords.txt";
...
date_default_timezone_set("Asia/Chongqing");
$create_table_name = "tda_records";//创建的表名
...
if(mysqli_num_rows(mysqli_query($conn,"SHOW TABLES LIKE '". $create_table_name."'"))==1) {
    ...
    $createtable = "create table $create_table_name($field1 int(10) UNSIGNED AUTO_INCREMENT PRIMARY KEY,$field2 int(10),$field3 int(10),$field4 int(11),$field5 int(11),$field6 double(8,2),$field7 int(11),$field8 double(8,2),$field9 datetime) default charset=utf8";
...
$insertShowtime = date("Y-m-d H:i:s");
$createShowtime = date("Ym");
$createTableDate = 'phpLoopRecords_tda_records';
