...
$read_table = "tdo_bill_logs";//读取的表名
...
//$startTime = date("2018-01-05 00:00:00");
//$stopTime = date("2018-01-05 23:59:59");
...
$txtFileName = "/toodo/crontab/txt/tdoBillLogs.txt";
...
date_default_timezone_set("Asia/Chongqing");
$create_table_name = "tdo_bill_logs";//创建的表名
...
if(mysqli_num_rows(mysqli_query($conn,"SHOW TABLES LIKE '". $create_table_name."'"))==1) {
    ...
    $createtable = "create table $create_table_name($field1 int(20) UNSIGNED AUTO_INCREMENT PRIMARY KEY,$field2 int(10),$field3 varchar(255),$field4 varchar(255),$field5 int(11),$field6 varchar(255),$field7 int(11),$field8 int(11),$field9 timestamp) default charset=utf8";
...
$insertShowtime = date("Y-m-d H:i:s");
$createShowtime = date("Ym");
$createTableDate = 'phpLoopRecords_tdo_bill_logs';
